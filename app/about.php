		...
		<div class="page_container">
			...
			<div class="colorTeaser">
				<div class="colorTeaser_box">
					...
					<h3 class="colorTeaser_box_title">Mission & <br>Services</h3>
				...
				<div class="colorTeaser_box">
					...
					<h3 class="colorTeaser_box_title">Make<br> Donations</h3>
					<div class="colorTeaser_box_text">
				...
				<div class="colorTeaser_box">
					...
					<h3 class="colorTeaser_box_title">Our<br> Programs</h3>
					<div class="colorTeaser_box_text">
		...
		<!-- END COLOR TEASER BOX -->
			<div class="content">
				<div class="content_block">
					...
					<img src="assets/img/page1_pic1.jpg" alt="">
					<div class="content_block_text">
						<p class="content_block_subtitle">Lorem ipsum dolor sit amet conse ctetur adipisicing elit sed do.</p>
						<p>Lorem ipsum dolor sit amet, vis te quando soluta. Nam facilisis suavitate disputando ex, ea est ubique propriae expetenda, amet incorrupte eam an. Ad ornatus voluptua scaevola vix, eius adhuc reprimique at mel.</p>
						<p>Suscipit efficiantur sit an, est decore laudem docendi cu, pro omnes labores perpetua et. Velit nostrud disputationi id duo, vel ei quis alia principes, ne laudem dicunt verear mei. Bonorum vocibus assueverit eu vix.</p>
					</div>
				</div>
				<div class="content_block">
					<h3 class="content_title">Our events</h3>
					<div class="content_block_text">
						<p class="content_block_subtitle">Lorem ipsum dolor sit amet</p>
						<p>Lorem ipsum dolor sit amet, vis te quando soluta. Nam facilisis suavitate disputando ex, ea est ubique propriae expetenda, amet incorrupte eam an.</p>
						<p class="content_block_subtitle">Lorem ipsum dolor sit amet</p>
						<p>Lorem ipsum dolor sit amet, vis te quando soluta. Nam facilisis suavitate disputando ex, ea est ubique propriae expetenda, amet incorrupte eam an.</p>
						<p class="content_block_subtitle">Lorem ipsum dolor sit amet</p>
						<p>Lorem ipsum dolor sit amet, vis te quando soluta. Nam facilisis suavitate disputando ex, ea est ubique propriae expetenda, amet incorrupte eam an.</p>
				...
				<div class="content_block">
					<h3 class="content_title">Job Opportunities</h3>
					<div class="content_block_text">
						<p class="content_block_subtitle">Lorem ipsum dolor sit amet conse ctetur adipisicing elit sed do.</p>
						<p>Lorem ipsum dolor sit amet, vis te quando soluta. Nam facilisis suavitate disputando ex, ea est ubique propriae expetenda, amet incorrupte eam an. Ad ornatus voluptua scaevola vix, eius adhuc reprimique at mel.</p>
						<p>Suscipit efficiantur sit an, est decore laudem docendi cu, pro omnes labores perpetua et. Velit nostrud disputationi id duo, vel ei quis alia principes, ne laudem dicunt verear mei. Bonorum vocibus assueverit eu vix. Te illum salutatus quo. Te eum eruditi appetere iudicabit, vix elit wisi omnesque ei.</p>
					</div>
					<a href="#" class="btn-read">Read more</a>
				</div>
			</div>
			<div class="content">
				<div class="content_title">Nas tim</div>
				<div class="team_block">
					<img src="assets/img/team1.jpg" alt="">
					<p class="team_block_name">Milena Budjevac</p>
					<p>Suscipit efficiantur sit an, est decore laudem docendi cu, pro omnes labores perpetua et. Velit nostrud disputationi id duo, vel ei quis alia principes, ne laudem dicunt verear mei. Bonorum vocibus assueverit eu vix. Te illum salutatus quo. Te eum eruditi appetere iudicabit, vix elit wisi omnesque ei.</p>
				</div>
				<div class="team_block">
					<img src="assets/img/team2.jpg" alt="">
					<p class="team_block_name">Petar Petrovic</p>
					<p>Suscipit efficiantur sit an, est decore laudem docendi cu, pro omnes labores perpetua et. Velit nostrud disputationi id duo, vel ei quis alia principes, ne laudem dicunt verear mei. Bonorum vocibus assueverit eu vix. Te illum salutatus quo. Te eum eruditi appetere iudicabit, vix elit wisi omnesque ei.</p>
				</div>
				<div class="team_block">
					<img src="assets/img/team3.jpg" alt="">
					<p class="team_block_name">Sladjana Petrovic</p>
					<p>Suscipit efficiantur sit an, est decore laudem docendi cu, pro omnes labores perpetua et. Velit nostrud disputationi id duo, vel ei quis alia principes, ne laudem dicunt verear mei. Bonorum vocibus assueverit eu vix. Te illum salutatus quo. Te eum eruditi appetere iudicabit, vix elit wisi omnesque ei.</p>
				</div>
			</div>
			<div class="footer">
